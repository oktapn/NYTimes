...
public class RVListArticleSearch extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof RVListArticleSearch.TextViewHolder) {
            ...
            final String tgl = contentItems.get(position).getPubDate();
